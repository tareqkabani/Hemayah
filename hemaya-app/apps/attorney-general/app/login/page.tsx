    ...
    <main style={{ minHeight: "100dvh", display: "grid", placeItems: "center", padding: 24,
      ...
      <div style={{ width: "100%", maxWidth: 400, background: "var(--surface-card)", border: "1px solid var(--border-subtle)",
        ...
        <div style={{ width: 52, height: 52, margin: "0 auto 14px", borderRadius: "var(--radius-md)",
          ...
          <span className="material-symbols-rounded" style={{ color: "#fff", fontSize: 26 }}>badge</span>
        </div>
        <h1 style={{ fontSize: 22, margin: "0 0 4px" }}>بوابة موظف المركز</h1>
        <p className="muted" style={{ fontSize: 14, margin: "0 0 24px" }}>الدخول عبر «نفاذ» — للموظّفين المُصرَّح لهم.</p>

        {phase === "id" ? (
          <div style={{ display: "grid", gap: 14, textAlign: "start" }}>
            <label style={{ fontSize: 13.5, fontWeight: 600, color: "var(--text-strong)" }}>رقم الهوية الوطنية</label>
            <input inputMode="numeric" maxLength={10} placeholder="1XXXXXXXXX" value={nid}
        ...
        <p className="muted" style={{ marginTop: 22, fontSize: 12, display: "flex", gap: 6, alignItems: "center", justifyContent: "center" }}>
          <Icon name="info" size={14} /> وضع تطويريّ (mock نفاذ) — الأدوار من البذور.
        </p>
      </div>
    </main>
  );
