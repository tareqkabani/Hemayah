...
export function StudyEvalPortal({ role, me, initial, basePath }) {
  ...
  const loadTasks = async () => {
    ...
    const [reqs, recs, dossiers] = await Promise.all([
      ...
      supabase.from("recommendations").select("case_id, source_body, decision, proposed_type, proposed_duration, factors9, notes, received_at, channel").in("case_id", missing),
