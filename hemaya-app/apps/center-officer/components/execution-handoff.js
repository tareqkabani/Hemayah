/* ============================================================
   ...
   ============================================================ */
import { signAgreement } from "@/lib/execution-actions";
  ...
  return {
    ...
    update: function (id, patch) {
      ...
      if (target && target.caseId && patch.status === 'active') {
        try { signAgreement(target.caseId).then(function (r) { if (r && !r.ok && typeof console !== 'undefined') console.error('sign_agreement:', r.error); }); } catch (e) {}
      }
