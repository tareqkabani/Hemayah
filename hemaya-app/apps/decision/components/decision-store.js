/* ============================================================
   ...
   ============================================================ */
import { DECISION_STAGES, decisionStageOf, nextDecisionAction, PROTECTION_TYPE_LABELS_14 } from "@hemaya/domain";
...
export const HemayaDecision = (function () {
  ...
  // أنواع تدابير الحماية (م14) — القائمة القانونية الموحّدة من الدومين
  // (كانت هنا ستة أنواع مخالفة للقائمة المعتمدة)
