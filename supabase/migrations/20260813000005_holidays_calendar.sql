...
--
-- ⚠️ ما لا يُبذر عمداً: عيدا الفطر والأضحى — قمريّان، وتاريخهما الميلادي
-- يتبع الرؤية ويُعلَن سنوياً؛ وتمديدُ اليوم الوطني حين يقع في نهاية
-- الأسبوع يُعلَن كذلك. تخمينُها يُنتج مُهلاً خاطئةً بثقةٍ زائفة — تُدخَل
-- من بوابة مدير النظام بتواريخها المعتمدة.
